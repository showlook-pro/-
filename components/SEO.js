...
const SEO = props => {
  ...
  return (
    <Head>
      ...
      <meta name='generator' content='ShowlookFans' />
      ...
      <meta name='twitter:site' content={siteConfig('TWITTER_SITE', '@Showlook小鹿医疗')} />
      <meta name='twitter:creator' content={siteConfig('TWITTER_CREATOR', '@Showlook小鹿医疗')} />
